...
/**
 * Provides the local service interface for WorkingTime. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author phantoan
 * @see WorkingTimeLocalServiceUtil
...
public interface WorkingTimeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkingTimeLocalServiceUtil} to access the working time local service. Add custom service methods to {@link com.liferay.usermanagement.service.impl.WorkingTimeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public WorkingTime createWorkingTime(long workingTimeId);
	...
	*/
	...
	public WorkingTime deleteWorkingTime(WorkingTime workingTime);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WorkingTime deleteWorkingTime(long workingTimeId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkingTime fetchWorkingTime(long workingTimeId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkingTime fetchWorkingTimeByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkingTime getWorkingTimeByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WorkingTime> getWorkingTimesByUuidAndCompanyId(
