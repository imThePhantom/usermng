...
public class DepartmentLocalServiceUtil {
	...
	*/
	...
	public static int getDepartmentsCount(long groupId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDepartmentsCount(groupId);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.usermanagement.model.Department> getDepartments(
		long groupId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDepartments(groupId);
	}

	public static java.util.List<com.liferay.usermanagement.model.Department> getDepartments(
		long groupId, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDepartments(groupId, start, end);
	}
