...
import com.liferay.usermanagement.service.WorkingTimeLocalService;
...
/**
 * Provides the base implementation for the working time local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.usermanagement.service.impl.WorkingTimeLocalServiceImpl}.
 * </p>
 *
 * @author phantoan
 ...
 */
@ProviderType
public abstract class WorkingTimeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements WorkingTimeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.usermanagement.service.WorkingTimeLocalServiceUtil} to access the working time local service.
	 */
	...
	public WorkingTime addWorkingTime(WorkingTime workingTime) {
		...
		return workingTimePersistence.update(workingTime);
	}
	...
	public WorkingTime createWorkingTime(long workingTimeId) {
		return workingTimePersistence.create(workingTimeId);
	}
	...
	public WorkingTime deleteWorkingTime(long workingTimeId)
		...
		return workingTimePersistence.remove(workingTimeId);
	}
	...
	public WorkingTime deleteWorkingTime(WorkingTime workingTime) {
		return workingTimePersistence.remove(workingTime);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(WorkingTime.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return workingTimePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return workingTimePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return workingTimePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public WorkingTime fetchWorkingTime(long workingTimeId) {
		return workingTimePersistence.fetchByPrimaryKey(workingTimeId);
	}
	...
	public WorkingTime getWorkingTime(long workingTimeId)
		throws PortalException {
		return workingTimePersistence.findByPrimaryKey(workingTimeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(workingTimeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(WorkingTime.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("workingTimeId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(workingTimeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(WorkingTime.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return workingTimeLocalService.deleteWorkingTime((WorkingTime)persistedModel);
	}
	...
	public List<WorkingTime> getWorkingTimes(int start, int end) {
		return workingTimePersistence.findAll(start, end);
	}
	...
	public int getWorkingTimesCount() {
		return workingTimePersistence.countAll();
	}
	 ...
	 */
	public com.liferay.usermanagement.service.UserInfoLocalService getUserInfoLocalService() {
	...
	public void setUserInfoLocalService(
		com.liferay.usermanagement.service.UserInfoLocalService userInfoLocalService) {
	 ...
	 */
	public WorkingTimeLocalService getWorkingTimeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.usermanagement.model.WorkingTime",
			workingTimeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.usermanagement.model.WorkingTime");
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkingTimeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = workingTimePersistence.getDataSource();
	...
	@BeanReference(type = com.liferay.usermanagement.service.UserInfoLocalService.class)
	protected com.liferay.usermanagement.service.UserInfoLocalService userInfoLocalService;
	@BeanReference(type = UserInfoPersistence.class)
	protected UserInfoPersistence userInfoPersistence;
	@BeanReference(type = WorkingTimeLocalService.class)
	protected WorkingTimeLocalService workingTimeLocalService;
